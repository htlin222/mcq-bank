#!/usr/bin/env python3
"""
Generate frontend/public/og-image.png — a 1200x630 OpenGraph card for
hema-2026's public landing. Deterministic: re-running produces the same PNG.
...
def main() -> None:
    ...
    # Tagline
    tagline = "血液腫瘤次專科考試 · 共筆詳解 · 全真模擬 · 答案挑戰"
    ...
    footer = "hema-2026.hsiehting.com"
    ...
    invite = "限 20 位內測使用者 · Cloudflare Zero Trust"
