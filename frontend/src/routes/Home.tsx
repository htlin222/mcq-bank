...
export function Home() {
  ...
  const [challengeFilter, setChallengeFilter] = useState<'all' | 'active' | 'promoted' | 'rejected'>('all');
  ...
  useEffect(() => {
    ...
    api
      .get<RecentChallenge[]>('/api/challenges/recent?limit=20&include=resolved')
      .then(setChallenges)
      .catch(() => setChallenges([]));
    ...
    <div className="max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 flex-wrap mb-4">
          <h2 className="font-serif text-xl text-ink-800 dark:text-ink-200 inline-flex items-center gap-2">
